...
export function nonce_new(a: number, b: number, c: number): number;
export function nonce_max_nonce(a: number): number;
export function nonce_local_hash(a: number, b: number): void;
